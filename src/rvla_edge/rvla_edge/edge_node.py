...
class VLAEdgeNode(LifecycleNode):
    ...
    def _declare_parameters(self) -> None:
        self.declare_parameter('observation_topic', '/rvla/observation')
        self.declare_parameter('remote_embedding_topic', '/rvla/remote_embedding')
        ...
        self.declare_parameter('goal_topic', '/rvla/goal')
        self.declare_parameter('path_topic', '/rvla/predicted_path')
        self.declare_parameter('status_topic', '/rvla/status')
        self.declare_parameter('embedding_debug_topic', '/rvla/embedding')
